...
#'
#' The 'uncertainty sampling' approach to active learning determines the unlabeled observation which the
#' user-specified supervised classifier is "least certain." The "least certain" observation should then
#' be queried by the oracle in the "active learning" framework.
#'
...
#' 2. margin: query the unlabeled observation that minimizes the difference in the largest two posterior
...
#'
#' The 'uncertainty' argument must be one of the three: 'entropy' is the default.Note that the three methods
#' are equivalent (they yield the same observation to be queried) with binary classification.
#'
